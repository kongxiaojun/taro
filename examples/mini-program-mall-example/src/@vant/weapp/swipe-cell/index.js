...
class _C extends React.Component {
  render() {
    const { catchMove, wrapperStyle, leftWidth, rightWidth } = this.data
    return (
      <View
        className="van-swipe-cell custom-class"
        data-key="cell"
        onClick={this.privateStopNoop.bind(this, this.onClick)}
        onTouchStart={this.startDrag}
        onTouchMove={catchMove ? 'noop' : ''}
        captureBindTouchmove="onDrag"
        ...
        <View style={wrapperStyle}>
          {leftWidth && (
            <View
              ...
              data-key="left"
              onTap={this.privateStopNoop.bind(this, this.onClick)}
            >
