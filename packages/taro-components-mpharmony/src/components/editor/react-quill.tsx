/*
Copy React-Quill version 2.0.0 source code
...
import HTMLEditorElement from './html-editor-element'
...
export interface ReactQuillProps {
  ...
  theme?: string
  value?: Value
  onReady?: (editor: UnprivilegedEditor) => void
}
...
class ReactQuill extends React.Component<ReactQuillProps, ReactQuillState> {
  ...
  */
  ...
  instantiateEditor (): void {
    ...
    this.props.onReady?.(this.unprivilegedEditor!)
  }
  ...
  */
  createEditor (element: Element, config: QuillOptions) {
    ...
    if (element instanceof HTMLEditorElement) {
      element.setEditors(editor)
    }
    return editor
  }
  ...
  */
  renderEditingArea (): ReactElement {
